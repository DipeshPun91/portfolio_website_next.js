...
export default function Home() {
  return (
    <>
      ...
      <section>
        <div className="container mx-auto flex flex-col lg:flex-row px-6 py-24 items-stretch gap-6">
          <div className="flex-1 flex flex-col items-center text-center lg:items-start lg:text-left p-6">
            ...
            <p className="mb-8 text-base sm:text-lg leading-relaxed text-gray-700">
              Full Stack Developer with expertise in building dynamic front-end
              interfaces and robust back-end systems. Committed to seamless
              integration, optimal performance, and delivering scalable
              solutions.
            </p>
